...
const routeEntity: Partial<Record<string, Entity>> = { tasks: 'tasks', time: 'timeLogs', projects: 'projects', knowledge: 'knowledge', reviews: 'reviews', insights: 'insights', principles: 'principles', mentalModels: 'mentalModels', decisions: 'decisions', events: 'events', people: 'people', externalIntelligence: 'signals' }
